        ...
        return (
            ...
            <View style={{
                ...
                <View style={{ flex: 0.2, alignItems: 'center', justifyContent: 'center' }}>
                    <View>
                        <Text style={{ fontSize: 15, fontWeight: 'bold', color: 'black' }}>Would you like to borrow $5000 or more additional cash</Text>
                    </View>
                ...
                <View style={{ flex: 0.5, flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <View style={{}}>
                        <TouchableOpacity style={{ padding: 5 }} onPress={() => Actions.Lates()}>
