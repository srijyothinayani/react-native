        ...
        return (
            ...
            <View style={{
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <View>
                        <Text style={{ fontSize: 15, fontWeight: 'bold', color: 'black' }}>Are you a veteran</Text>
                    </View>

                </View>
                <View style={{ flexDirection: 'row' }}>
                    <TouchableOpacity style={{ width: 150, padding: 5 }} onPress={() => Actions.PropertyInfo()}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <TouchableOpacity style={{ width: 150, padding: 5 }} onPress={() => Actions.Lates()}>
