...
export default class PropertyValue extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                <View style={{}}>
                    <Text style={{ textAlign: 'center' }}>Property Value</Text>
                </View>
                <View style={{ width: 200 }}>
                    <RangeSlider min={1000} max={100000} initialStart={1000} initialEnd={1000} color="red" />
                </View>
            </View>
        )
    }
            ...
            <View style={{}}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <TouchableOpacity style={{ width: 150, padding: 5 }} onPress={() => Actions.CreditTypes()}>
                        <Text style={{ fontSize: 20, borderWidth: 1, borderColor: '#eee', textAlign: 'center' }}>Back</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ width: 150, padding: 5 }} onPress={() => Actions.MortgageBalance()}>
                        <Text style={{ fontSize: 20, borderWidth: 1, borderColor: '#eee', textAlign: 'center' }}>Next</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
