...
export default class InterestRates extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                <View style={{}}>
                    <Text style={{ textAlign: 'center' }}>Current Interest Rate</Text>
                </View>
                <View style={{ width: 200 }}>
                    <RangeSlider min={10} max={100000} initialStart={10} initialEnd={100000} color="red" />
                </View>
            </View>
        )
    }
        ...
        return (
            <View>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <TouchableOpacity style={{ width: 150, backgroundColor: 'green', padding: 5 }} onPress={() => Actions.DownPayament()}>
