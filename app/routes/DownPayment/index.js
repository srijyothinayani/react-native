...
export default class DownPayament extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                <View style={{}}>
                    <Text style={{ textAlign: 'center' }}>How much you are putting down as a downpayment</Text>
                </View>
                <View style={{ width: 200 }}>
                    <RangeSlider min={10} max={10000} initialStart={100} initialEnd={10000} color="red" />
                </View>
            </View>
        )
    }
        ...
        return (
            <View>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <TouchableOpacity style={{ width: 150,backgroundColor:'green',   padding: 5 }} onPress={() => Actions.Bankrupts()}>
