        ...
        return (
            ...
            <View style={{
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <View>
                        <Text style={{ fontSize: 15, fontWeight: 'bold', color: 'black' }}>How many Mortgages late do you have past 12months ?</Text>
                    </View>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <TouchableOpacity style={{ width: 150, padding: 5 }} onPress={() => Actions.Veteran()}>
                        <Text style={{ fontSize: 20, borderWidth: 1, borderColor: '#eee', backgroundColor: 'green', textAlign: 'center' }}>Back</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ width: 150, backgroundColor: 'green', padding: 5 }} onPress={() => Actions.Borrow()}>
