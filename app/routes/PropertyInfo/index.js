                ...
                <View style={{ flex: 0.5, flexDirection: 'column', alignItems: 'center' }}>
                    <View style={styles.customLoginView}>
                        <Item rounded style={styles.itemStyle}>
                            <Icon style={styles.iconSpace} size={20} name="search" />
                            <Input style={styles.textBoxStyle} placeholder="Address" placeholderTextColor="#d3d3d3" />
                        </Item>
                        <Item rounded style={styles.itemStyle}>
                            <Icon style={styles.iconSpace} size={20} name="search" />
                            <Input style={styles.textBoxStyle} placeholder="City" placeholderTextColor="#d3d3d3" />

                        </Item>
                        <Item rounded style={styles.itemStyle}>
                            <Icon style={styles.iconSpace} size={20} name="search" />
                            <Input style={styles.textBoxStyle} placeholder="Zip" placeholderTextColor="#d3d3d3" />
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <TouchableOpacity style={{ padding: 5 }} onPress={() => Actions.Borrow()}>
                        ...
                        <TouchableOpacity style={{ padding: 5 }} onPress={() => Actions.HomeOwner()}>
                        <Text style={{ textAlign: 'center', justifyContent: 'center', width: 150, fontSize: 20, backgroundColor: 'green', color: '#fff', borderWidth: 1, borderColor: '#eee', textAlign: 'center' }}>Next</Text>
                    </TouchableOpacity>
                    </View>
                </View>
